...
export const addTodoAction = (formData) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.post('http://localhost:4800/api/todo', formData)
        console.log(data);
...
export const getTodoAction = () => async (dispatch, getstate) => {
    ...
    try {
        ...
        const { data } = await axios.get('http://localhost:4800/api/todo', config)
        // console.log(data);
...
export const updateStatusAction = (id, val) => async (dispatch, getstate) => {
    ...
    try {
        ...
        // }
        const { data } = await axios.put(`http://localhost:4800/api/todo/status/${id}`, { status: val })
...
export const editTodoAction = (id, fd) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.put(`http://localhost:4800/api/todo/update/${id}`, fd)
        dispatch(getTodoAction())
...
export const deleteSingleTodoAction = (id) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.delete(`http://localhost:4800/api/todo/delete/${id}`)
...
export const deleteAllTodoAction = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.delete("http://localhost:4800/api/todo")
